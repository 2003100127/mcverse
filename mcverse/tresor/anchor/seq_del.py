...
for permut_i in range(permutation_times):
    ...
    for i, criterion in enumerate(criteria):
        ts.locus.simu_generic(
            ...
            seq_num=50,
            seq_len=100,
            working_dir='../../data/tresor/simu/seq_del/permute_' + str(permut_i) + '/',
            ...
            sv_fastq_fp='../../data/tresor/simu/seq_del/permute_' + str(permut_i) + '/',
            sv_fastq_fn="seq_del_" + str(i),
        )