...
ts.gene.simu_pcr_err(
    ...
    seq_params={
        'custom': 'ATGCAT',
        'custom_1': 'TTTTTTTTTTTTTTTTTTTTTTTT',
    },
    material_params={
        # 'fasta_cdna_fpn': to('data/Homo_sapiens.GRCh38.cdna.all.fa.gz'),  # None False
    },
    seq_num=50,
    working_dir='D:/Document/Programming/Python/umiche/umiche/data/r1/seqtech/simu/vasaseq/',
    ...
    sv_fastq_fp='D:/Document/Programming/Python/umiche/umiche/data/r1/seqtech/simu/vasaseq/',
    sv_fastq_fn='vasaseq',
