...
ts.gene.simu_pcr_err(
    ...
    seq_num=50,
    working_dir='D:/Document/Programming/Python/umiche/umiche/data/r1/seqtech/simu/issaac/',
    ...
    sv_fastq_fp='D:/Document/Programming/Python/umiche/umiche/data/r1/seqtech/simu/issaac/',
    sv_fastq_fn='issaac',
