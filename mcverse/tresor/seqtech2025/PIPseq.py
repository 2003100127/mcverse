...
ts.gene.simu_pcr_err(
    ...
    seq_params={
        'custom': 'ATGCATGCATGCATGCATGCATGCATGC',
        'custom_1': 'TTTTTTTTTTTTTTTTTTT',
    },
    material_params={
        # 'fasta_cdna_fpn': to('data/Homo_sapiens.GRCh38.cdna.all.fa.gz'),  # None False
    },
    seq_num=50,
    working_dir='D:/Document/Programming/Python/umiche/umiche/data/r1/seqtech/simu/pipseq/',
    ...
    sv_fastq_fp='D:/Document/Programming/Python/umiche/umiche/data/r1/seqtech/simu/pipseq/',
    sv_fastq_fn='pipseq',
